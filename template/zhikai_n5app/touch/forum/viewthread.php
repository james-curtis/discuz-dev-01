...
<div class="n5sq_ztnr cl">
	...
	<!--{if $post['first']}-->
		...
		<div class="n5sq_nrbk cl">
			<div class="nrbk_bktb z cl"><a href="forum.php?mod=forumdisplay&fid=$_G[fid]"><img src="<!--{if $_G['forum'][icon]}-->{if checkIsGroup($_G['fid'])}data/attachment/group/$_G['forum'][icon]{else}{if stripos($_G['forum'][icon],'http') !== false}$_G['forum'][icon]{else}data/attachment/common/$_G['forum'][icon]{/if}{/if}<!--{else}-->template/zhikai_n5app/images/forum.png<!--{/if}-->"></a></div>
