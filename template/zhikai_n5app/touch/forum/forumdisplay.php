...
<div class="n5sq_clzt">
	<div class="clzt_bkxx cl">
		<div class="bkxx_bktb cl"><img alt="$_G['forum'][name]" src="<!--{if $_G['forum'][icon]}--><!--{if stripos($_G['forum'][icon],'http') !== false}-->$_G['forum'][icon]<!--{else}-->data/attachment/common/$_G['forum'][icon]<!--{/if}--><!--{else}-->template/zhikai_n5app/images/forum.png<!--{/if}-->"></div>
...
<!--{if !$subforumonly}-->
	<!--{if empty($_G['forum']['sortmode']) || in_array($_G['fid'],unserialize($n5app['noflxxfid']))}-->
