...
class misc_forum_upload {
	...
	function misc_forum_upload($getaid = 0) {
		global $_G;
	...
	function uploadmsg($statusid) {
		...
		$local_object = $_G['bineoo_storage']['oss_set']['attachdir'].'forum/'.$this->attach['attachment'];
		$object = $_G['bineoo_storage']['oss_set']['attachurl'].'forum/'.$this->attach['attachment'];
