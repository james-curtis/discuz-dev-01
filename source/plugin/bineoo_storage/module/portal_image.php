...
/*if($_G['bineoo_storage']['ossClient']->doesObjectExist($_G['bineoo_storage']['oss_set']['bucket'], $object)){
	dheader('location: '.$_G['bineoo_storage']['oss_set']['domain'].$object."?x-oss-process=image/resize,m_fill,h_$dw,w_$dh");
	exit;
}*/
if($oss_set['direct_oss']) {
	dheader('location: '.$_G['bineoo_storage']['oss_set']['domain'].$object."?x-oss-process=".($oss_set['image_style']?$oss_set['image_style']:'image')."/resize,m_fill,h_$dw,w_$dh");
	exit;
} else {
	if($_G['bineoo_storage']['ossClient']->doesObjectExist($_G['bineoo_storage']['oss_set']['bucket'], $object)){
		dheader('location: '.$_G['bineoo_storage']['oss_set']['domain'].$object."?x-oss-process=".($oss_set['image_style']?$oss_set['image_style']:'image')."/resize,m_fill,h_$dw,w_$dh");
