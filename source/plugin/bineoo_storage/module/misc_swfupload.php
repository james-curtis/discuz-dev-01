...
if($_GET['operation'] == 'upload') {
	...
	require_once DISCUZ_ROOT.'./source/plugin/bineoo_storage/class/misc_forum_upload.php';
	$upload = new misc_forum_upload();
	...
	if(!$errorcode) {
		...
		$local_object = $_G['bineoo_storage']['oss_set']['attachdir'].'forum/'.$attach['attachment'];
		$local_object_thumb = $_G['bineoo_storage']['oss_set']['attachdir'].'forum/'.$attach['attachment'].'.thumb.jpg';
		$object = $_G['bineoo_storage']['oss_set']['attachurl'].'forum/'.$attach['attachment'];
		$object_thumb = $_G['bineoo_storage']['oss_set']['attachurl'].'forum/'.$attach['attachment'].'.thumb.jpg';
		if(is_file($local_object)){
			$_G['bineoo_storage']['ossClient']->multiuploadFile($_G['bineoo_storage']['oss_set']['bucket'], $object, $local_object);
		}
		if(is_file($local_object_thumb)){
			$_G['bineoo_storage']['ossClient']->multiuploadFile($_G['bineoo_storage']['oss_set']['bucket'], $object_thumb, $local_object_thumb);
		}
	...
	if(!$errorcode) {
		...
		if($attach['isimage']) {
			...
			$local_object = $_G['bineoo_storage']['oss_set']['attachdir'].'portal/'.$attach['attachment'];
			$local_object_thumb = $_G['bineoo_storage']['oss_set']['attachdir'].'portal/'.$attach['attachment'].'.thumb.jpg';
