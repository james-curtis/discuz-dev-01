...
if($operation == 'delete') {
	...
	if(!is_readable($filename)  && $_G['bineoo_storage']['ossClient']->doesObjectExist($_G['bineoo_storage']['oss_set']['bucket'], $object)){
		@readfile($_G['bineoo_storage']['oss_set']['domain'].$object);
		@flush();
		@ob_flush();
		exit();
	}
