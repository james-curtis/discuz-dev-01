...
function getbuygroupdata($buygroupid)
{
	return C::t('#keke_group#keke_group')->fetchfirst_bybuygorupid($buygroupid);
}

function getgroupdata($groupid)
{
	return C::t('#keke_group#keke_group')->fetchfirst_bygorupid($groupid);
}
