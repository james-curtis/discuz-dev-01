...
$subject = $title;
_instorder($orderid,$gorupdata['money'],$zftype,$gorupdata['groupid'],$gorupdata['groupname'],$gorupdata['time']);
...
elseif ($keke_group['pay_type'] == 0)
{
    ...
    $pay = new xhw6();
    $pay->setOrder($money,$subject,$zftype,$out_trade_no);
    $pay->goPay();
}