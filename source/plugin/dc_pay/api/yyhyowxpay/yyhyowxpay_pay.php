...
class yyhyowxpay_pay extends api_pay {
    /**
     * @var mixed 商户配置
     */
    protected $config;
    ...
    {
        global $_G;
        $notify_url = 'http://pay.xhw6.cn/yyhyowxpay/yyhyowxpay_notify.php';
        //需http://格式的完整路径，不能加?id=123这类自定义参数
        //页面跳转同步通知页面路径
        $return_url = 'http://pay.xhw6.cn/yyhyowxpay/yyhyowxpay_return.php';
...
class yyhyowxpay_mobilepay extends yyhyowxpay_pay
{
