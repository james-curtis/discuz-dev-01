...
/**
 *序列号：2018071721T2ttMTp7D6
 *应用版本：316
 *发布时间：1534665602
 *站点URL：http://www.xhkj5.com/	
 *客户端URL：http://www.xhw6.cn/	
 *站点ID：06443AD0-0691-06DC-5C9D-4D7B98743055	
...
if(!submitcheck('editsubmit')) {
	$operation = '';
	if($pluginvars) {
		$_statInfo = array();$_statInfo['pluginName'] = $plugin['identifier'];$_statInfo['pluginVersion'] = $plugin['version'];$_statInfo['bbsVersion'] = DISCUZ_VERSION;$_statInfo['bbsRelease'] = DISCUZ_RELEASE;$_statInfo['timestamp'] = TIMESTAMP;$_statInfo['bbsUrl'] = $_G['siteurl'];$_statInfo['SiteUrl'] = 'http://www.xhkj5.com/';$_statInfo['ClientUrl'] = 'http://www.xhw6.cn/';$_statInfo['SiteID'] = '06443AD0-0691-06DC-5C9D-4D7B98743055';$_statInfo['bbsAdminEMail'] = $_G['setting']['adminemail'];$_statInfo['genuine'] = splugin_genuine($plugin['identifier']);
		...
		foreach($pluginvars as $var) {
			...
			if($var['type'] == 'number') {
				...
				$var['type'] = 'calendar';//站点ID：06443AD0-0691-06DC-5C9D-4D7B98743055	
				...
				$var['variable'] = $var['value'] = '';
			} elseif(substr($var['type'], 0, 5) == 'group') {//发布时间：1534665602
				if($var['type'] == 'groups') {
					$var['description'] = ($var['description'] ? (isset($lang[$var['description']]) ? $lang[$var['description']] : $var['description'])."\n" : '').$lang['plugins_edit_vars_multiselect_comment']."\n".$var['comment'];
					$var['value'] = dunserialize($var['value']);
				...
				$var['variable'] = $var['value'] = '';//客户端URL：http://www.xhw6.cn/
				...
				$var['type'] .= '</select>';
				$var['variable'] = $var['value'] = '';//站点URL：http://www.xhkj5.com/
			}
