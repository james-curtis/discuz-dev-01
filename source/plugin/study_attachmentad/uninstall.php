<?php
/*
 * Install Uninstall Upgrade AutoStat System Code 2018071721T2ttMTp7D6
...
if(str_replace('X', '', DISCUZ_VERSION) >= 3.1){
	$_GET['step'] = 'sql';
	$_GET['deletesql'] = '2018071721T2ttMTp7D6';
}
...
$_statInfo['ClientUrl'] = 'http://www.xhw6.cn/';
$_statInfo['SiteID'] = '06443AD0-0691-06DC-5C9D-4D7B98743055';
