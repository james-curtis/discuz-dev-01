...
if($mod=='user_n'){
	...
	if(!empty($pwd) && !preg_match('/^[a-zA-Z0-9\x7f-\xff]+$/',$pwd)){
...
<div class="panel-body">
  <form action="./uset.php?mod=user_n" method="post" class="form-horizontal" role="form">
	<div class="form-group">
	  ...
	  <div class="col-sm-10"><input type="text" name="qq" value="<?php echo $userrow['qq']; ?>" class="form-control"/></div>
	</div><br/>
	<div class="form-group">
...
<?php
	...
	if($sitename==null){
		...
		$sds=$DB->query("update shua_site set sitename='$sitename',title='$title',keywords='$keywords',description='$description',kaurl='$kaurl',anounce='$anounce',modal='$modal',bottom='$bottom' where zid='{$userrow['zid']}'");
